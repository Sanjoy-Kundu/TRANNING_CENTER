        ...
        <div class="col-12 col-lg-9 order-2 order-md-3 order-lg-2 mb-4 mx-auto">
          <div class="card">
            ...
            <div class="row row-bordered g-0">
                @if ($your_rejected_notices->count() > 0)
                <h4 class="text-center p-2"><strong>Total Rejected Notice ({{$your_rejected_notices->count()}})</strong></h4>
                @else
                <h4 class="text-center p-2"><strong>All Rejected Notice  lists</strong></h4>
                @endif
              ...
              <div class="col-md-12 col-12 col-xl-12 col-xxl-12 p-5">
                    ...
                    <table id="notice_table" class="display" style="width:100%">
                        ...
                        <tbody>
                          @if ($your_rejected_notices->count() > 0)
                              @foreach ($your_rejected_notices as $notice )
                              <tr>
