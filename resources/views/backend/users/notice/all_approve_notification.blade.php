        ...
        <div class="col-12 col-lg-9 order-2 order-md-3 order-lg-2 mb-4 mx-auto">
          <div class="card">
            ...
            <div class="row row-bordered g-0">
                @if ($all_approve_notices->count() > 0)
                <h4 class="text-center p-2"><strong>Total Notice ({{$all_approve_notices->count()}})</strong></h4>
                @else
              ...
              <div class="col-md-12 col-12 col-xl-12 col-xxl-12 p-5">
                    @if ($all_approve_notices->count() > 0)
                    <table id="approve_notice_table" class="display" style="width:100%">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          @if ($all_approve_notices->count() > 0)
                              @foreach ($all_approve_notices as $notice )
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                        ...
                                        <button type="button" class="btn btn-info"><a href="{{route('notice.reject', $notice->id)}}" class="text-white">REJECT</a></button>
