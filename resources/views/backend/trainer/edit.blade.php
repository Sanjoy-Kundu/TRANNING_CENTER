        ...
        <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4 mx-auto">
          <div class="card">
            ...
            <div class="row row-bordered g-0">
                <h4 class="text-center p-2"><strong>Update Your TRAINERS</strong></h4>
              <div class="col-md-12 col-12 col-xl-12 col-xxl-12 p-5">
                    <form action="{{url('trainer/update')}}/{{$trainer->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="trainer_title" value="{{$trainer->trainer_title}}">

                          </div>

                          <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label"><b class="fs-5">Trainers Description</b></label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="trainer_description">{{$trainer->trainer_description}}</textarea>

                          </div>

                          <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label"><b class="fs-5">Trainers Salary</b></label>
                            <input type="number" class="form-control" name="trainer_salary" value="{{$trainer->trainer_salary}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="trainer_facebook_link" value="{{$trainer->trainer_facebook_link}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="trainer_linkdin_link" value="{{$trainer->trainer_linkdin_link}}">
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <button class="btn  btn-success" type='submit' style="background-color: rgb(68, 77, 204);">Upload Trainers</button>
                          </div>
